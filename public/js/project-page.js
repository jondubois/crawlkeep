...
const clusterCirclingParams = [
  // Sydney Metro (green circle, middle right)
  { cx: 527, cy: 351, r: 80 },
  // Central Coast (green circle, top right)
  { cx: 601, cy: 74, r: 55 },
  // Western Sydney (red circle, bottom left)
  {
    cx: 270,
    cy: 240,
    r: 90,
  },
]; // Coordinates of shapes based on natural dimensions of the image
...
const steps = [
  {
    ...
    absTiming: 0,
    log: "Scroll to top at animation start",
  },
  {
    index: 1,
    id: "company-table-title",
    absTiming: 1000,
    classNames: ["green-bg-border"],
    log: "Highlight company table title",
  },
  {
    index: 2,
    id: "company-card",
  ...
  {
    index: 4,
    id: "employee-table-title",
    absTiming: 5000,
    classNames: ["green-bg-border"],
    log: "Highlight employee table title",
  },
  {
    index: 5,
    id: "employee-table",
  ...
  },
  {
    ...
    absTiming: 11000,
    classNames: ["green-bg-border"],
    areaSelection: { rowIndices: [3] },
    log: "Highlight SentinelOne record",
  },
  {
    index: 10,
  ...
  // {
  //   index: 16,
  //   id: "source-employee-map-image",
  //   actionName: "drawMultipleCirclesOnImage",
  //   absTiming: 49500,
  //   overlayId: "employee-map-overlay",
  //   classNames: ["svg-green-circle"],
  //   areaSelection: [clusterCirclingParams[0], clusterCirclingParams[1]],
  //   log: "draw green circles",
  // },
  // {
  //   index: 17,
  //   id: "source-employee-map-image",
  //   actionName: "drawCircleOnImage",
  //   absTiming: 54350,
  //   overlayId: "employee-map-overlay",
  //   classNames: ["svg-red-circle"],
  //   areaSelection: clusterCirclingParams[2],
  //   log: "draw red circle",
  // },
  {
    index: 18,
...
document.addEventListener("DOMContentLoaded", () => {
  const animationManager = new AnimationManager(steps);
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  employeeViewSelect.addEventListener("change", function () {
    if (this.value === "Map") {
      ...
      const img = document.createElement("img");
      img.id = "source-employee-map-image";
      img.src = IMG_SOURCE;
      img.alt = "Map";
