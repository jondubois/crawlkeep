...
/**
 * @description Navigates to the next or previous highlighted term in the DOM and updates the active index
 * @param {number} next_prev - Direction of navigation: 1 for next, -1 for previous
 */
