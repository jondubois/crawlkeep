import { atobJSON } from "../../manip-data/modules/encoding-decoding.js";
import { gi } from "./get-elm.js";
import { inlineStyler } from "./inline-styler.js";
import { topZIndexer } from "./top-z-indexer.js";

/**
 * @description Adjusts the size of a specified element dynamically based on mouse drag events.
 * The function allows resizing of an element and its associated child elements while maintaining
 * minimum width constraints and updating styles dynamically. It also integrates with a Chrome
 * extension to save the element's latest position.
 * @param {Event} event - The event object triggered by the `mousedown` event on the resize handle.
 * The event is used to determine the initial mouse position and the target elements to resize.
 * @return {void} This function does not return a value. It modifies the DOM element's size and style directly.
 */
