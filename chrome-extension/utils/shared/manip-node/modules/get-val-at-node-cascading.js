/**
 * @description traverses node tree from `root_node`, to retrieve the property value at the tail end of the path, which segments are stored in order in  `abs_path_segments`
 *
